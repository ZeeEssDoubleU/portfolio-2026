export type IconName = 'logo' | 'logo-landing' | 'logo-nav' | 'arrow-down' | 'arrow-down-a' | 'stripes' | 'github' | 'linkedin' | 'dribbble' | 'twitter' | 'email' | 'copyright' | 'minus' | 'plus' | 'check' | 'ellipsis' | 'map-marker'
...
const Icon = (props: React.SVGProps<SVGSVGElement> & { name?: IconName }) => {
  switch (props.name) {
    case "logo":
      return <Logo {...props} />
    case "logo-landing":
